...
export function SubscriptionStatus({ user }: SubscriptionStatusProps) {
  ...
  if (user.subscriptionStatus === 'past_due') {
    return (
      <div
        className="bg-github-attention-subtle border border-github-attention-muted rounded-github p-4 mb-4"
        role="alert"
        aria-live="polite"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm text-github-attention-fg font-semibold mb-1">
              Payment Failed
            </p>
            <p className="text-sm text-github-fg-default mb-3">
  ...
  if (user.subscriptionStatus === 'canceled' && user.subscriptionCancelAt) {
    ...
    return (
      <div
        className="bg-github-canvas-subtle border border-github-border-default rounded-github p-4 mb-4"
        role="status"
        aria-live="polite"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm text-github-fg-default font-semibold mb-1">
              Subscription Ending
            </p>
